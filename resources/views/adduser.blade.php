...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <form method="POST" id="form-id" action="{{ route('ingresarFormulario') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="correo" name="correo" placeholder="Ingrese el correo del usuario">
            </div>
            <div class="form-group">
